...
import AllModals from "@/components/DashboardModals";
...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-[var(--bg-body)] font-sans text-[var(--text-primary)] relative">
        ...
        <main className="flex-1 overflow-y-auto p-6 scroll-smooth">
          ...
          {activeView === "observation" && observationSubTab === "dashboard" && (
            <ObservationDashboard 
              observationDataStats={observationDataStats}
              notObservedStats={notObservedStats}
              recentObservations={recentObservations}
              observationTrendData={observationTrendData}
              lobsStats={lobsStats}
              overallCompletion={overallCompletion}
              missedObservationsStats={missedObservationsStats}
              wowChartsData={wowChartsData}
              notObsDept={notObsDept}
              setNotObsDept={setNotObsDept}
              setRecentObsModalOpen={setRecentObsModalOpen}
              setSelectedObs={setSelectedObs}
              setMissedObsModalOpen={setMissedObsModalOpen}
              setWowChartsModalOpen={setWowChartsModalOpen}
      ...
      <AllModals 
        recentObsModalOpen={recentObsModalOpen}
        setRecentObsModalOpen={setRecentObsModalOpen}
        recentObservations={recentObservations}
        setSelectedObs={setSelectedObs}
        missedObsModalOpen={missedObsModalOpen}
        setMissedObsModalOpen={setMissedObsModalOpen}
        missedObservationsStats={missedObservationsStats}
        wowChartsModalOpen={wowChartsModalOpen}
        setWowChartsModalOpen={setWowChartsModalOpen}
        wowChartsData={wowChartsData}
        selectedObs={selectedObs}
        setSelectedObsNull={() => setSelectedObs(null)}
        getAvatarColor={getAvatarColor}
        getInitials={getInitials}
      />
    </div>
